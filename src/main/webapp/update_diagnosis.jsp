...
<%
    ...
    if (session == null || username == null || !"Doctor".equals(userType)) {
...
<head>
    ...
    <title>Update Diagnosis - MBC Hospital</title>
    ...
    <div class="main-content">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                ...
                <a href="referred-diagnoses" class="text-blue-600 hover:text-blue-800 flex items-center">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-8 animate-fade-in">
            <div class="bg-gradient-to-r from-blue-50 to-white px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                    ...
                    Diagnosis for: <span class="text-blue-700 ml-2">${patientName}</span>
                </h2>
            </div>
            
            <div class="p-6">
                <form action="update-diagnosis" method="post" class="space-y-6">
                    <input type="hidden" name="diagnosisID" value="${diagnosis.diagnosisId}">
                    <input type="hidden" name="patientID" value="${diagnosis.patientId}">
                    
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nurse Assessment</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                <label class="flex p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                    <input type="radio" name="diagnoStatus" value="Positive" class="form-radio h-5 w-5 text-primary-600 mt-0.5" 
                                           ${diagnosis.status eq 'Positive' ? 'checked' : ''}>
                                    <div class="ml-3">
                                ...
                                <label class="flex p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                    <input type="radio" name="diagnoStatus" value="Negative" class="form-radio h-5 w-5 text-primary-600 mt-0.5"
                                           ${diagnosis.status eq 'Negative' ? 'checked' : ''}>
                                    <div class="ml-3">
                                ...
                                <label class="flex p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                    <input type="radio" name="diagnoStatus" value="Referrable" class="form-radio h-5 w-5 text-amber-600 mt-0.5"
                                           ${diagnosis.status eq 'Referrable' ? 'checked' : ''}>
                                    <div class="ml-3">
                                        <span class="block font-medium text-gray-900">Awaiting Diagnosis</span>
                                        <span class="text-sm text-gray-500">Diagnosis pending further review</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="result" name="result" rows="5" 
                                ...
                                placeholder="Enter detailed diagnosis results and any instructions for the patient...">${diagnosis.result}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" id="medicationsPrescribed" name="medicationsPrescribed" 
                                   value="${diagnosis.medicationsPrescribed}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="followUpDate" name="followUpDate" 
                                   value="<fmt:formatDate value="${diagnosis.followUpDate}" pattern="yyyy-MM-dd"/>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        </div>
                    </div>
                    
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                        <a href="referred-diagnoses" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition flex items-center">
